...
public class UserController {
	...
	private IDeptmentService  dpservice;
	...
	public List<UserEntity> select(@RequestBody UserEntity entity) {
	...
	public PageData<UserEntity> likeSelect(@RequestBody UserEntity entity) {
	...
	public void add(@RequestBody UserEntity entity) {
		service.add(entity);
	}
